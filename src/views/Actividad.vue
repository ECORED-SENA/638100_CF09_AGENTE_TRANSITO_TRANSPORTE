  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          h2 Investigando buenas prácticas en la conducción de vehículos.
        p.mb-4 Afianzar conceptos y saberes para las buenas prácticas y hábitos para una conducción segura, con base en los temas desarrollados en el componente formativo.
