    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          name: 'tema6',
          component: () =>
            import(/* webpackChunkName: "tema6" */ '../views/Tema7.vue'),
        },
        {
          path: 'tema7',
          name: 'tema7',
        ...
        },
        {
          ...
          name: 'tema9',
          component: () =>
            import(/* webpackChunkName: "tema9" */ '../views/Tema10.vue'),
        },
        {
          path: 'tema10',
          name: 'tema10',
          component: () =>
            import(/* webpackChunkName: "tema10" */ '../views/Tema11.vue'),
        },
        {
          path: 'tema11',
          name: 'tema11',
          component: () =>
            import(/* webpackChunkName: "tema11" */ '../views/Tema12.vue'),
        },
      ],
    },
    {
